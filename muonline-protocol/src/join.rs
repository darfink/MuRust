...
//! ```
//!
//! > Server → Client ([JoinServerConnectResult](./struct.JoinServerConnectResult.html))
//!
//! ```c
//! [0xC1, 0x04, 0x00, 0x01]
//! ```
//!
//! > Client → Server ([GameServerListRequest](../client/struct.GameServerListRequest.html))
//!
//! ```c
//! [0xC1, 0x04, 0xF4, 0x06]
//! ```
...
/// Field | Type | Description | Endianess
/// ----- | ---- | ----------- | ---------
/// count | `U16` | The number of [GameServerListEntry](./struct.GameServerListEntry.html) in this response. | LE
...
impl GameServerListEntry {
    pub fn new(code: GameServerCode, load: GameServerLoad) -> Self {
        GameServerListEntry { code, load, unknown: 0x77 }
    }
}
